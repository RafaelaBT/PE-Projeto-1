...
int palavrasPuzzle();
  ...
  void cronometro()
  {
    int i = 10; // Magia o porque usar o parâmetro não funciona.
    do
    {
      printf("\t%i\n", i);
      sleep(1);
  ...
  int palavrasPuzzle()
  {
    ...
    // printf("Tamanho da diferença: %i\n", strcmp(frase, uppercase(resposta)));

    if (strcmp(frase, uppercase(resposta)))
    {
      return 0;
    }
    else
